...
export const MODALITIES: Modality[] = [
  // IDs sincronizados com o banco de dados
  ...
  { id: 2, name: 'Milhar', value: '1x R$ 5000.00', hasLink: true },
  { id: 3, name: 'Dupla de Grupo', value: '1x R$ 180.00', hasLink: false },
  { id: 4, name: 'Milhar/Centena', value: '1x R$ 3300.00', hasLink: false },
  { id: 5, name: 'Terno de Grupo', value: '1x R$ 1800.00', hasLink: false },
  { id: 6, name: 'Centena', value: '1x R$ 600.00', hasLink: false },
  { id: 7, name: 'Quadra de Grupo', value: '1x R$ 5000.00', hasLink: false },
  { id: 8, name: 'Dezena', value: '1x R$ 60.00', hasLink: false },
  { id: 9, name: 'Quina de Grupo', value: '1x R$ 5000.00', hasLink: false },
  { id: 10, name: 'Milhar Invertida', value: '1x R$ 200.00', hasLink: false },
  { id: 11, name: 'Duque de Dezena', value: '1x R$ 300.00', hasLink: false },
  { id: 12, name: 'Centena Invertida', value: '1x R$ 600.00', hasLink: false },
  { id: 13, name: 'Terno de Dezena', value: '1x R$ 5000.00', hasLink: false },
  { id: 14, name: 'Dezena Invertida', value: '1x R$ 60.00', hasLink: false },
  { id: 15, name: 'Passe vai', value: '1x R$ 300.00', hasLink: false },
